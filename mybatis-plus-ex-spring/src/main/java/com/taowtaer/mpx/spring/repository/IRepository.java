...
interface IRepository<T> {
     ...
     */
    default QueryChainExWrapper<T> query() {
        return new QueryChainExWrapper<>(getBaseMapper());
    }
     ...
     */
    default LambdaQueryChainExWrapper<T> lambdaQuery() {
        return new LambdaQueryChainExWrapper<>(getBaseMapper(), getEntityClass());
    }
     ...
     * @return LambdaQueryWrapper 的包装类
     */
    default LambdaQueryChainExWrapper<T> lambdaQuery(T entity) {
        return new LambdaQueryChainExWrapper<>(getBaseMapper(), entity);
    }
     ...
     */
    default LambdaUpdateChainExWrapper<T> lambdaUpdate() {
        return new LambdaUpdateChainExWrapper<>(getBaseMapper());
    }
}
